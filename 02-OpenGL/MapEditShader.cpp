...
MapEditShader::MapEditShader(){}
MapEditShader::MapEditShader(GLuint* gShaderP)
{
...
bool MapEditShader::compile()
{
	...
	const char* fragment_shader = R"(
		...
		void main () 
		{
			fragment_color = texture(heightMapSampler, texCoordsGeo);
		}
	)";
...
void MapEditShader::LinkErrorPrint(GLuint* gShaderProgram)
{
	GLint success;
...
void MapEditShader::CompileErrorPrint(GLuint* shader)
{
	GLint success;
